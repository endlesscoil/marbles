...
/* 
    Borrowed from https://raw.githubusercontent.com/snowkit/mint/master/tests/test_luxe/src/AutoCanvas.hx and modified
    to make code style compatible.
*/
...
class AutoCanvas extends mint.Canvas {
    ...
    function conv_mousewheel(e)     mousewheel(Convert.mouse_event(e, scale, Luxe.renderer.batcher.view));
    function conv_mousedown(e)      mousedown(Convert.mouse_event(e, scale, Luxe.renderer.batcher.view));
    function conv_mouseup(e)        mouseup(Convert.mouse_event(e, scale, Luxe.renderer.batcher.view));
    function conv_mousemove(e)      mousemove(Convert.mouse_event(e, scale, Luxe.renderer.batcher.view));
